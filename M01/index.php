    ...
    <div class="row">
      ...
      <main class="col-md-9 col-lg-10 content">
        ...
        <div>
          ...
          <div class="card">
            <div class="d-flex align-items-start">
              <img src="Images/<?php echo empty($post['attachment']) ? 'chan.jpg' : $post['attachment']; ?>" alt="Profile Picture" class="profile-img me-3">
              <div>
                ...
                <div class="d-flex">
                  <button class="action-btn"><i class="far fa-comment"></i> <?php echo rand(0, 20); ?></button>
                  <button class="action-btn"><i class="fas fa-retweet"></i> <?php echo rand(5, 50); ?></button>
                  <button class="action-btn"><i class="far fa-heart"></i> <?php echo rand(10, 100); ?></button>
                  <button class="action-btn"><i class="fas fa-share"></i> <?php echo rand(100, 500); ?></button>
                </div>
              </div>
            </div>
          </div>
